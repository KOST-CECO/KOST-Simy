...
package ch.kostceco.tools.kostsimy.exception;

/** Superklasse aller Applikations-Exceptions
 * 
 * @author Rc Claire Röthlisberger, KOST-CECO */

public class KOSTSimyException extends Exception
{

	private static final long	serialVersionUID	= -8666753675661449719L;

	public KOSTSimyException()
	{
		super();
	}

	public KOSTSimyException( String message )
	{
		super( message );
	}
