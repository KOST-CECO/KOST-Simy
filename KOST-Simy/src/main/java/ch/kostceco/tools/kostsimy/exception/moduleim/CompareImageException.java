...
package ch.kostceco.tools.kostsimy.exception.moduleim;

import ch.kostceco.tools.kostsimy.exception.KOSTSimyException;

public class CompareImageException extends KOSTSimyException
{
	...
	public CompareImageException( String message )
	{
		super( message );
	}
