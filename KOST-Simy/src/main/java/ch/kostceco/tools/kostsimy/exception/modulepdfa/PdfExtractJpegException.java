...
package ch.kostceco.tools.kostsimy.exception.modulepdfa;

import ch.kostceco.tools.kostsimy.exception.KOSTSimyException;

public class PdfExtractJpegException extends KOSTSimyException
{

	/** @author Rc Claire Röthlisberger, KOST-CECO */
	private static final long	serialVersionUID	= -8816841335398903517L;

	public PdfExtractJpegException( String message )
	{
		super( message );
	}
