...
package ch.kostceco.tools.kostsimy.exception.moduleaudio;

import ch.kostceco.tools.kostsimy.exception.KOSTSimyException;

public class CompareAudioException extends KOSTSimyException
{
	...
	public CompareAudioException( String message )
	{
		super( message );
	}
